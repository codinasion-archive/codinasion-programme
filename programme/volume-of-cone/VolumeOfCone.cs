...
namespace Codinasion.Programme
{
    internal class VolumeOfCone
    {
        public static void Main()
        {
            ...
            Console.WriteLine($"\nA cone with a radius of {cone.Radius} and a height of {cone.Height} has a volume of {cone.Volume}");
        }
    ...
    internal class Cone
    {
        ...
        public double Volume => (double)1 / 3 * Math.PI * Math.Pow(Radius, 2) * Height;
